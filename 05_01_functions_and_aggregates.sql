...
SELECT COUNT(*) AS total_employees
  ...
  -- COUNT + GROUP BY – Employees per Department
...
FROM employees;
  ...
  -- AVG + GROUP BY – Department Average Salary
...
GROUP BY dept_id;
  ...
  -- HAVING + COUNT – Departments with 2+ Employees
...
FROM employees;
  ...
  -- NULL HANDLING – IFNULL (DATA CLEANING QUERY)
...
FROM employees;
  ...
  -- FILTERED GROUP ANALYSIS – HIGH SALARY DEPARTMENTS
...
-- FILTERED DEPARTMENT ANALYSIS (GROUP BY + HAVING + ORDER BY)
